...
<body>
    ...
    <section class="px-5 laptop:px-20 pt-10" data-aos="fade-top" data-aos-anchor-placement="top-bottom" data-aos-duration="2000">
        <livewire:card.detail-information :content="$content">
    </section>
