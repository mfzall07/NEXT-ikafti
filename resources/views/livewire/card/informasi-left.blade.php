<div class="bg-white rounded-lg shadow-md border">
    ...
    <div class="p-5">
        <a href="{{ route('informationDetail') }}" id="title" class="font-bold text-xl break-words hover:text-blue-500 line-clamp-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Purus libero quam </a>
