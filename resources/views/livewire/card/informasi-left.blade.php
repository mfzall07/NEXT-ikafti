<div class="bg-white rounded-lg shadow-md border">
    ...
    <img src={{ url( $info->thumbnail != null ? str_replace('public', 'storage',$info->thumbnail) : 'assets/images/exampleContent.jpg')}} class="h-56 bg-center bg-cover object-cover w-full rounded-t-lg" alt="">
    <div class="p-5">
