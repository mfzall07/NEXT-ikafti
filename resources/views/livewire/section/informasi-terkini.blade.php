<div>
    ...
    <div class="flex flex-col gap-5 laptop:gap-0 laptop:grid grid-cols-12">
        <div class="col-span-5 laptop:pr-10" >
            <livewire:card.informasi-left>
        </div>
        <div class="col-span-7 laptop:pl-10 laptop:border-l-2 border-t-2 laptop:border-t-0">
            <livewire:card.informasi-right>
        </div>
    </div>
</div>