<!-- Main modal -->
<div id="view-alumni" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
            ...
            <div class="p-5 flex items-center gap-5">
                ...
                <div class="self-baseline grid grid-cols-12 gap-5 w-full">
                    ...
                    <div class="col-span-8 w-full">
                        ...
                        <h1 class="mb-2">Powerkerto</h1>
                        <h1 class="mb-2">Jl. Beringin</h1>
                        <h1 class="mb-2">Makassar</h1>
                        <h1 class="mb-2">admin@admin.com</h1>
                        <h1 class="mb-2">Makassar</h1>
                        <h1 class="mb-2">03 Jul 1999</h1>
                        <h1 class="mb-2">2017</h1>
                        <h1 class="mb-2">Teknik Kimia</h1>
