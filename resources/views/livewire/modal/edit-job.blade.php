                ...
                <div class="py-6 px-6 lg:px-8">
                    ...
                    <form class="space-y-6" action="#">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model.defer="title" name="edit_title" id="edit_title" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Title" required>
