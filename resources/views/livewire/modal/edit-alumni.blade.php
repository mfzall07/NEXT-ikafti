                    ...
                    <form class="space-y-6" action="#">
                        ...
                        <div class="flex items-center gap-5">
                            ...
                            <div class="w-full">
                                ...
                                <input type="text" wire:model.defer="generation" name="edit_generation" id="edit_generations" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Generation" required>
