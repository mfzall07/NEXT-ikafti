                        ...
                        <div>
                            ...
                            <div class="flex justify-center items-center w-full">
                                <label for="dropzone-files" class="flex flex-col justify-center items-center w-full h-64 bg-gray-50 rounded-lg border-2 border-gray-300 border-dashed cursor-pointer dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                    ...
                                    <input id="dropzone-files" wire:model="new_proof" type="file" accept=".png,.jpg,.jpeg,.pdf" class="hidden" />
                                    <div wire:loading wire:target="new_proof">
                                        Uploading...
                                    </div>
                                    @error('new_proof') <span class="text-red-500">{{ $message }}</span> @enderror
                                </label>
                            </div>
                        </div>
