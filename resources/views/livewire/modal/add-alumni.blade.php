                ...
                <form class="space-y-6" action="#">
                    ...
                    <div class="flex items-center gap-5">
                        <div class="w-full">
                            ...
                            <input type="text" name="birth_place" id="birth_place" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Birth Place" required>
                        </div>
                        <div class="w-full">
