<div>
    <button data-modal-toggle="change-password" modal-change-password hidden></button>
                    ...
                    <li>
                        ...
                        <div id="dropdownAvatar" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                            ...
                            <ul class="py-1 text-sm text-gray-700" aria-labelledby="profile">
                              <li>
                                <button type="button" wire:click="$emit('change-password', {{ auth()->user()->id }})" class="block py-2 px-4 hover:bg-gray-100 w-full text-left">Change Password</button>
                              </li>
                            </ul>
                            <div class="py-1">
