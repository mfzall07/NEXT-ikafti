    ...
    <div class="flex flex-col laptop:flex-row gap-4 laptop:items-center laptop:justify-between py-5">
        <div class="flex flex-row justify-between items-center laptop:items-start laptop:flex-col">
            <div class="flex items-center gap-4">
                ...
                <button type="button" data-modal-toggle="add-alumni">
                    <i class="fa-solid fa-circle-plus mt-1"></i>
                </button>
            </div>
            <span class="text-gray-400 font-semibold text-sm">10 Alumni</span>
        </div>
        <div class="flex items-center laptop:w-auto w-full">   
            ...
            <div class="flex items-center gap-5">
                <div class="relative w-full">
                    ...
                    <input type="text" id="searchAlumniList" onkeyup="searchAlumniList()" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-full focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 " placeholder="Search" required>
                </div>
            </div>
        </div>
    </div>
                ...
                <tr class="bg-white border-b">
                    ...
                    <td class="py-4 px-6">
                        <div class="flex flex-row items-center gap-2">
                            ...
                            <h1 class="font-bold text-black  hover:text-blue-500 truncate">Alumni 1</h1>
                        </div>
                    </td>
                    <td class="py-4 px-6">
                        <h1 class="font-semibold truncate">Makassar</h1>
                    </td>
                    <td class="py-4 px-6">
                        <h1 class="font-semibold truncate">+6281245527645</h1>
                    </td>
                    <td class="py-4 px-6">
                        <h1 class="font-semibold truncate">2017</h1>
                    </td>
                    <td class="py-4 px-6">
                        <div class="flex items-center gap-4">
