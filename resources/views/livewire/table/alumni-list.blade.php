            ...
            <div class="flex items-center laptop:w-auto w-full">
                ...
                <div class="flex items-center gap-5">
                    <div class="relative w-full">
                        ...
                        <input type="text" id="searchAlumniList" wire:model="search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-full focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 " placeholder="Search" required>
                    </div>
                </div>
            </div>
        </div>
