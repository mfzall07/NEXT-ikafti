    ...
    <div class="flex flex-col laptop:flex-row gap-4 laptop:items-center laptop:justify-between py-5">
        <div class="flex flex-row justify-between items-center laptop:items-start laptop:flex-col">
            <div class="flex items-center gap-4">
                ...
                <button type="button" data-modal-toggle="add-announcement">
        ...
        <div class="flex items-center laptop:w-auto w-full">   
            ...
            <div class="flex items-center gap-5">
                <div class="relative w-full">
                    ...
                    <input type="text" id="searchAnnouncementList" onkeyup="searchAnnouncementList()" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-full focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 " placeholder="Search" required>
                </div>
            </div>
        </div>
    </div>
        ...
        <table class="w-full text-sm text-left text-gray-500" id="AnnouncementList">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b">
                    ...
                    <td class="py-4 px-6">
                        <a href="#" class="font-bold text-black line-clamp-1">Admin 1</a>
                    </td>
                    <td class="py-4 px-6">
                        <a href="#" class="line-clamp-1">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Animi, odit.</a>
                    </td>
                    <td class="py-4 px-6">
                        <div class="flex items-center gap-4">
                            <button type="button" data-tooltip-target="edit_announc" data-modal-toggle="edit-announcement" class="w-7 h-7 flex items-center justify-center rounded-lg font-semibold text-white bg-green-400">
